      ...
      00000B 02 02 89         [24]  330 	ljmp	_t0_interrupt
                                    ...
                                    344 ;	DSM-51-CLOCK-IN-C.c:18: unsigned char CLOCK_ARRAY[6] = {1, 4, 5, 5, 3, 2};    // TABLICA WYŒWIETLAJ¥CA ZEGAREK
      ...
      000079 75 0F 02         [24]  350 	mov	(_CLOCK_ARRAY + 0x0005),#0x02
                                    351 ;	DSM-51-CLOCK-IN-C.c:21: __xdata unsigned char * ACTIVE_DISPLAY_BUFFER = (__xdata unsigned char *) 0xFF30;               // BUFOR WYBIERAJ¥CY AKTYWNY WYŒWIETLACZ DLA WYŒWIETLACZA 7-SEGMENTOWEGO
      00007C 75 10 30         [24]  352 	mov	_ACTIVE_DISPLAY_BUFFER,#0x30
      00007F 75 11 FF         [24]  353 	mov	(_ACTIVE_DISPLAY_BUFFER + 1),#0xff
                                    354 ;	DSM-51-CLOCK-IN-C.c:22: __xdata unsigned char * ACTIVE_DISPLAY_SEGMENTS_BUFFER = (__xdata unsigned char *) 0xFF38;      // BUFOR WYBIERAJ¥CY AKTYWNE SEGMENTY WYŒWIETLACZA
      ...
      000085 75 13 FF         [24]  356 	mov	(_ACTIVE_DISPLAY_SEGMENTS_BUFFER + 1),#0xff
                                    357 ;	DSM-51-CLOCK-IN-C.c:41: unsigned char KEYBOARD[4] = {0, 0, 0, 0};    // TABLICA PRZECHOWUJ¥CA STANY KLAWIATURY
      ...
      00000E 02 02 F2         [24]  370 	ljmp	_main
                                    ...
                                    378 ;------------------------------------------------------------
                                    379 ;	DSM-51-CLOCK-IN-C.c:63: void test_led() {
                                    380 ;	-----------------------------------------
      ...
      0000A9                        415 00102$:
                                    416 ;	DSM-51-CLOCK-IN-C.c:75: ACTIVE_DISPLAY_INDEX = 0;
      0000A9 75 14 00         [24]  417 	mov	_ACTIVE_DISPLAY_INDEX,#0x00
                                    418 ;	DSM-51-CLOCK-IN-C.c:76: ACTIVE_DISPLAY_BIT = 1;
      0000AC 75 15 01         [24]  419 	mov	_ACTIVE_DISPLAY_BIT,#0x01
                                    420 ;	DSM-51-CLOCK-IN-C.c:78: }
      0000AF 22               [24]  421 	ret
                                    422 ;------------------------------------------------------------
                                    423 ;Allocation info for local variables in function 'display'
                                    424 ;------------------------------------------------------------
                                    425 ;	DSM-51-CLOCK-IN-C.c:81: void display() {
                                    426 ;	-----------------------------------------
                                    427 ;	 function display
                                    428 ;	-----------------------------------------
      0000B0                        429 _display:
                                    430 ;	DSM-51-CLOCK-IN-C.c:82: DISPLAY_SWITCH = TRUE;                                                                          // W£¥CZA WYŒWIETLACZ LED
                                    431 ;	assignBit
      0000B0 D2 96            [12]  432 	setb	_DISPLAY_SWITCH
                                    433 ;	DSM-51-CLOCK-IN-C.c:83: * ACTIVE_DISPLAY_BUFFER = ACTIVE_DISPLAY_BIT;                                                   // WYBIERA WYŒWIETLACZ LED
      ...
      0000BA F0               [24]  437 	movx	@dptr,a
                                    438 ;	DSM-51-CLOCK-IN-C.c:84: * ACTIVE_DISPLAY_SEGMENTS_BUFFER = DISPLAY_PATTERNS[CLOCK_ARRAY[ACTIVE_DISPLAY_INDEX]];         // WYBIERA SEGMENTY WYŒWIETLACZA LED
      ...
      0000CD F0               [24]  449 	movx	@dptr,a
                                    450 ;	DSM-51-CLOCK-IN-C.c:85: DISPLAY_SWITCH = FALSE;                                                                         // WY£¥CZA WYŒWIETLACZ LED
                                    451 ;	assignBit
      0000CE C2 96            [12]  452 	clr	_DISPLAY_SWITCH
                                    453 ;	DSM-51-CLOCK-IN-C.c:86: display_handler();                                                                              // ZMIENIAJ SEGMENTY WYŒWIETLACZA
                                    454 ;	DSM-51-CLOCK-IN-C.c:87: }
      0000D0 02 00 9A         [24]  455 	ljmp	_display_handler
                                    456 ;------------------------------------------------------------
                                    457 ;Allocation info for local variables in function 'keyboard_handler'
                                    458 ;------------------------------------------------------------
                                    459 ;	DSM-51-CLOCK-IN-C.c:94: void keyboard_handler() {
                                    460 ;	-----------------------------------------
                                    461 ;	 function keyboard_handler
                                    462 ;	-----------------------------------------
      0000D3                        463 _keyboard_handler:
                                    464 ;	DSM-51-CLOCK-IN-C.c:96: if((KEYBOARD[0] != KEYBOARD[1]) && (KEYBOARD[0] != KEYBOARD[2]) && (KEYBOARD[0] != KEYBOARD[3])) {
      ...
      0000FB                        490 00110$:
                                    491 ;	DSM-51-CLOCK-IN-C.c:102: if((CLOCK_ARRAY[5] < 1) || ((CLOCK_ARRAY[5] < 2) && (CLOCK_ARRAY[4] < 6))) {
      ...
      00010C                        502 00104$:
                                    503 ;	DSM-51-CLOCK-IN-C.c:103: CLOCK_ARRAY[4] = 0;
      00010C 75 0E 00         [24]  504 	mov	(_CLOCK_ARRAY + 0x0004),#0x00
                                    505 ;	DSM-51-CLOCK-IN-C.c:104: CLOCK_ARRAY[5]++;
      ...
      000118                        511 00105$:
                                    512 ;	DSM-51-CLOCK-IN-C.c:105: } else if((CLOCK_ARRAY[4] == 9) && (CLOCK_ARRAY[5] == 1)) {
      ...
      000142                        541 00115$:
                                    542 ;	DSM-51-CLOCK-IN-C.c:114: if(CLOCK_ARRAY[3] < 6) {
      ...
      00014B                        547 00284$:
                                    548 ;	DSM-51-CLOCK-IN-C.c:115: CLOCK_ARRAY[2] = 0;
      00014B 75 0C 00         [24]  549 	mov	(_CLOCK_ARRAY + 0x0002),#0x00
                                    550 ;	DSM-51-CLOCK-IN-C.c:116: CLOCK_ARRAY[3]++;
      ...
      000171                        575 00289$:
                                    576 ;	DSM-51-CLOCK-IN-C.c:124: CLOCK_ARRAY[0] = 0;
      000171 75 0A 00         [24]  577 	mov	_CLOCK_ARRAY,#0x00
                                    578 ;	DSM-51-CLOCK-IN-C.c:125: CLOCK_ARRAY[1]++;
      ...
      00017C                        584 00149$:
                                    585 ;	DSM-51-CLOCK-IN-C.c:129: } else if(KEYBOARD[0] == (ESC | LEFT)) {
      00017C BF 22 25         [24]  586 	cjne	r7,#0x22,00146$
                                    587 ;	DSM-51-CLOCK-IN-C.c:130: if(CLOCK_ARRAY[4] > 0) {
      00017F E5 0E            [12]  588 	mov	a,(_CLOCK_ARRAY + 0x0004)
      000181 FE               [12]  589 	mov	r6,a
      000182 60 06            [24]  590 	jz	00128$
                                    591 ;	DSM-51-CLOCK-IN-C.c:131: CLOCK_ARRAY[4]--;
      ...
      00018A                        596 00128$:
                                    597 ;	DSM-51-CLOCK-IN-C.c:133: if(CLOCK_ARRAY[5] > 0) {
      00018A E5 0F            [12]  598 	mov	a,(_CLOCK_ARRAY + 0x0005)
      00018C 60 0B            [24]  599 	jz	00125$
                                    600 ;	DSM-51-CLOCK-IN-C.c:134: CLOCK_ARRAY[4] = 9;
      00018E 75 0E 09         [24]  601 	mov	(_CLOCK_ARRAY + 0x0004),#0x09
                                    602 ;	DSM-51-CLOCK-IN-C.c:135: CLOCK_ARRAY[5]--;
      ...
      0001A4                        618 00146$:
                                    619 ;	DSM-51-CLOCK-IN-C.c:140: } else if(KEYBOARD[0] == (ESC | DOWN)) {
      0001A4 BF 12 25         [24]  620 	cjne	r7,#0x12,00143$
                                    621 ;	DSM-51-CLOCK-IN-C.c:141: if(CLOCK_ARRAY[2] > 0) {
      0001A7 E5 0C            [12]  622 	mov	a,(_CLOCK_ARRAY + 0x0002)
      0001A9 FE               [12]  623 	mov	r6,a
      0001AA 60 06            [24]  624 	jz	00136$
                                    625 ;	DSM-51-CLOCK-IN-C.c:142: CLOCK_ARRAY[2]--;
      ...
      0001B2                        630 00136$:
                                    631 ;	DSM-51-CLOCK-IN-C.c:144: if(CLOCK_ARRAY[3] > 0) {
      0001B2 E5 0D            [12]  632 	mov	a,(_CLOCK_ARRAY + 0x0003)
      0001B4 60 0B            [24]  633 	jz	00133$
                                    634 ;	DSM-51-CLOCK-IN-C.c:145: CLOCK_ARRAY[2] = 9;
      0001B6 75 0C 09         [24]  635 	mov	(_CLOCK_ARRAY + 0x0002),#0x09
                                    636 ;	DSM-51-CLOCK-IN-C.c:146: CLOCK_ARRAY[3]--;
      ...
      0001F3                        693 00102$:
                                    694 ;	DSM-51-CLOCK-IN-C.c:170: ACTIVE_KEYBOARD_DISPLAY_BIT += ACTIVE_KEYBOARD_DISPLAY_BIT;
      ...
      0001F7 F5 1A            [12]  697 	mov	_ACTIVE_KEYBOARD_DISPLAY_BIT,a
                                    698 ;	DSM-51-CLOCK-IN-C.c:172: if(ACTIVE_KEYBOARD_DISPLAY_BIT == 0b1000000) {
      0001F9 74 40            [12]  699 	mov	a,#0x40
      0001FB B5 1A 0D         [24]  700 	cjne	a,_ACTIVE_KEYBOARD_DISPLAY_BIT,00107$
                                    701 ;	DSM-51-CLOCK-IN-C.c:173: ACTIVE_DISPLAY_INDEX = 0;
      0001FE 75 14 00         [24]  702 	mov	_ACTIVE_DISPLAY_INDEX,#0x00
                                    703 ;	DSM-51-CLOCK-IN-C.c:174: ACTIVE_KEYBOARD_DISPLAY_BIT = 0b0000001;
      000201 75 1A 01         [24]  704 	mov	_ACTIVE_KEYBOARD_DISPLAY_BIT,#0x01
                                    705 ;	DSM-51-CLOCK-IN-C.c:175: if(KEYBOARD[0] != 0) {
      000204 E5 16            [12]  706 	mov	a,_KEYBOARD
      000206 60 03            [24]  707 	jz	00107$
                                    708 ;	DSM-51-CLOCK-IN-C.c:176: keyboard_handler();
                                    709 ;	DSM-51-CLOCK-IN-C.c:179: }
      ...
      00020B 22               [24]  712 	ret
                                    ...
                                    715 ;------------------------------------------------------------
                                    716 ;	DSM-51-CLOCK-IN-C.c:186: void update_seconds() {
                                    717 ;	-----------------------------------------
                                    718 ;	 function update_seconds
                                    719 ;	-----------------------------------------
      00020C                        720 _update_seconds:
                                    721 ;	DSM-51-CLOCK-IN-C.c:188: if(CLOCK_ARRAY[0] == 10) {
      00020C 74 0A            [12]  722 	mov	a,#0x0a
      00020E B5 0A 09         [24]  723 	cjne	a,_CLOCK_ARRAY,00102$
                                    724 ;	DSM-51-CLOCK-IN-C.c:189: CLOCK_ARRAY[0] = 0;
      000211 75 0A 00         [24]  725 	mov	_CLOCK_ARRAY,#0x00
                                    726 ;	DSM-51-CLOCK-IN-C.c:190: CLOCK_ARRAY[1]++;
      ...
      000254                        795 00102$:
                                    796 ;	DSM-51-CLOCK-IN-C.c:221: if(((CLOCK_ARRAY[5] == 2) && (CLOCK_ARRAY[4] >= 4)) || (CLOCK_ARRAY[5] >= 3)) {
      ...
      00028B C0 D0            [24]  856 	push	psw
                                    857 ;	DSM-51-CLOCK-IN-C.c:244: TH0 = 228;                      // USTAW TH0
      00028D 75 8C E4         [24]  858 	mov	_TH0,#0xe4
                                    859 ;	DSM-51-CLOCK-IN-C.c:245: TL0 = 124;                      // USTAW TL0
      000290 75 8A 7C         [24]  860 	mov	_TL0,#0x7c
                                    861 ;	DSM-51-CLOCK-IN-C.c:246: INTERRUPT_T0_FLAG = 1;          // SYGNALIZUJ PRZERWANIE
                                    862 ;	assignBit
      000293 D2 01            [12]  863 	setb	_INTERRUPT_T0_FLAG
                                    864 ;	DSM-51-CLOCK-IN-C.c:247: T0_INTERRUPTS_COUNTER++;        // ZAKTUALIZUJ LICZNIK PRZERWAÑ T0
      ...
      00029D                        869 00109$:
                                    870 ;	DSM-51-CLOCK-IN-C.c:249: if(T0_INTERRUPTS_COUNTER >= 1024) {
      ...
      0002A4 40 08            [24]  875 	jc	00103$
                                    876 ;	DSM-51-CLOCK-IN-C.c:250: SECOND_PASSED_FLAG = TRUE;
                                    877 ;	assignBit
      0002A6 D2 00            [12]  878 	setb	_SECOND_PASSED_FLAG
                                    879 ;	DSM-51-CLOCK-IN-C.c:251: T0_INTERRUPTS_COUNTER -= 1024;
      ...
      0002B2 32               [24]  887 	reti
                                    ...
                                    894 ;------------------------------------------------------------
                                    895 ;	DSM-51-CLOCK-IN-C.c:260: void initialize() {
                                    896 ;	-----------------------------------------
                                    897 ;	 function initialize
                                    898 ;	-----------------------------------------
      0002B3                        899 _initialize:
                                    900 ;	DSM-51-CLOCK-IN-C.c:262: T0_INTERRUPTS_COUNTER = FALSE;
      0002B3 E4               [12]  901 	clr	a
      0002B4 F5 08            [12]  902 	mov	_T0_INTERRUPTS_COUNTER,a
      0002B6 F5 09            [12]  903 	mov	(_T0_INTERRUPTS_COUNTER + 1),a
                                    904 ;	DSM-51-CLOCK-IN-C.c:263: SECOND_PASSED_FLAG = FALSE;
                                    905 ;	assignBit
      0002B8 C2 00            [12]  906 	clr	_SECOND_PASSED_FLAG
                                    907 ;	DSM-51-CLOCK-IN-C.c:264: INTERRUPT_T0_FLAG = FALSE;
                                    908 ;	assignBit
      0002BA C2 01            [12]  909 	clr	_INTERRUPT_T0_FLAG
                                    910 ;	DSM-51-CLOCK-IN-C.c:267: ACTIVE_KEYBOARD_DISPLAY_INDEX = 0;
      0002BC 75 1B 00         [24]  911 	mov	_ACTIVE_KEYBOARD_DISPLAY_INDEX,#0x00
                                    912 ;	DSM-51-CLOCK-IN-C.c:268: ACTIVE_KEYBOARD_DISPLAY_BIT = 0b00000001;
      0002BF 75 1A 01         [24]  913 	mov	_ACTIVE_KEYBOARD_DISPLAY_BIT,#0x01
                                    914 ;	DSM-51-CLOCK-IN-C.c:271: ACTIVE_DISPLAY_INDEX = 0;
      0002C2 75 14 00         [24]  915 	mov	_ACTIVE_DISPLAY_INDEX,#0x00
                                    916 ;	DSM-51-CLOCK-IN-C.c:272: ACTIVE_DISPLAY_BIT = 0b00000001;
      0002C5 75 15 01         [24]  917 	mov	_ACTIVE_DISPLAY_BIT,#0x01
                                    918 ;	DSM-51-CLOCK-IN-C.c:275: TH0 = 228;
      0002C8 75 8C E4         [24]  919 	mov	_TH0,#0xe4
                                    920 ;	DSM-51-CLOCK-IN-C.c:276: TH1 = 250;
      0002CB 75 8D FA         [24]  921 	mov	_TH1,#0xfa
                                    922 ;	DSM-51-CLOCK-IN-C.c:277: TL0 = 124;
      0002CE 75 8A 7C         [24]  923 	mov	_TL0,#0x7c
                                    924 ;	DSM-51-CLOCK-IN-C.c:278: TL1 = 250;
      0002D1 75 8B FA         [24]  925 	mov	_TL1,#0xfa
                                    926 ;	DSM-51-CLOCK-IN-C.c:281: TF1 = FALSE;
                                    927 ;	assignBit
      0002D4 C2 8F            [12]  928 	clr	_TF1
                                    929 ;	DSM-51-CLOCK-IN-C.c:282: RI = FALSE;
                                    930 ;	assignBit
      0002D6 C2 98            [12]  931 	clr	_RI
                                    932 ;	DSM-51-CLOCK-IN-C.c:283: TI = FALSE;
                                    933 ;	assignBit
      0002D8 C2 99            [12]  934 	clr	_TI
                                    935 ;	DSM-51-CLOCK-IN-C.c:286: ET0 = TRUE;
                                    936 ;	assignBit
      0002DA D2 A9            [12]  937 	setb	_ET0
                                    938 ;	DSM-51-CLOCK-IN-C.c:287: ES = TRUE;
                                    939 ;	assignBit
      0002DC D2 AC            [12]  940 	setb	_ES
                                    941 ;	DSM-51-CLOCK-IN-C.c:288: EA = TRUE;
                                    942 ;	assignBit
      0002DE D2 AF            [12]  943 	setb	_EA
                                    944 ;	DSM-51-CLOCK-IN-C.c:289: TR0 = TRUE;
                                    945 ;	assignBit
      0002E0 D2 8C            [12]  946 	setb	_TR0
                                    947 ;	DSM-51-CLOCK-IN-C.c:290: TR1 = TRUE;
                                    948 ;	assignBit
      0002E2 D2 8E            [12]  949 	setb	_TR1
                                    950 ;	DSM-51-CLOCK-IN-C.c:291: }
      0002E4 22               [24]  951 	ret
                                    952 ;------------------------------------------------------------
                                    953 ;Allocation info for local variables in function 'clock'
                                    954 ;------------------------------------------------------------
                                    955 ;	DSM-51-CLOCK-IN-C.c:298: void clock() {
                                    956 ;	-----------------------------------------
                                    957 ;	 function clock
                                    958 ;	-----------------------------------------
      0002E5                        959 _clock:
                                    960 ;	DSM-51-CLOCK-IN-C.c:300: if(INTERRUPT_T0_FLAG == 1) {
                                    961 ;	DSM-51-CLOCK-IN-C.c:301: INTERRUPT_T0_FLAG = 0;      // USTAW FLAGÊ PRZERWANIA NA 0
                                    962 ;	assignBit
      0002E5 10 01 01         [24]  963 	jbc	_INTERRUPT_T0_FLAG,00109$
      0002E8 22               [24]  964 	ret
      0002E9                        965 00109$:
                                    966 ;	DSM-51-CLOCK-IN-C.c:302: update_time();              // OBS£U¯ LICZNIK CZASU
      0002E9 12 02 77         [24]  967 	lcall	_update_time
                                    968 ;	DSM-51-CLOCK-IN-C.c:303: keyboard();                 // OBS£U¯ KLAWIATURÊ
      0002EC 12 01 E8         [24]  969 	lcall	_keyboard
                                    970 ;	DSM-51-CLOCK-IN-C.c:304: display();                  // OBS£U¯ WYŒWIETLACZ
                                    971 ;	DSM-51-CLOCK-IN-C.c:306: }
      0002EF 02 00 B0         [24]  972 	ljmp	_display
                                    973 ;------------------------------------------------------------
                                    974 ;Allocation info for local variables in function 'main'
                                    975 ;------------------------------------------------------------
                                    976 ;	DSM-51-CLOCK-IN-C.c:312: void main() {
                                    977 ;	-----------------------------------------
                                    978 ;	 function main
                                    979 ;	-----------------------------------------
      0002F2                        980 _main:
                                    981 ;	DSM-51-CLOCK-IN-C.c:314: initialize();
      0002F2 12 02 B3         [24]  982 	lcall	_initialize
                                    983 ;	DSM-51-CLOCK-IN-C.c:317: while(TRUE) {
      0002F5                        984 00102$:
                                    985 ;	DSM-51-CLOCK-IN-C.c:318: clock();
      0002F5 12 02 E5         [24]  986 	lcall	_clock
                                    987 ;	DSM-51-CLOCK-IN-C.c:320: }
